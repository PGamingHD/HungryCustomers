...
module.exports = {
    name: "gend", //userMoney, userBank, userBitcoin, userID (ALL USERVALUES)
    aliases: ['giveawayend', 'giveend'],
    /**
     *
     * @param {Client} client
    ...
    run: async (client, message, args) => {
        ...
        if (giveaway) {
            try {
                client.giveawaysManager.end(searchquery)
                return message.reply('Success! Giveaway ended!');
            } catch (e) {
